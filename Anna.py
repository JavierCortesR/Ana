...
class Ventanabyn(QMainWindow):
    ...
    def seleccionar_archivo(self):
        archivo, ok = QFileDialog.getOpenFileName(self, 'Seleccionar archivo de imagen...', 'C:\\Users', 'Archivos de imagen (*.jpg *.png)')
        if ok:
...
#Definir Funciones para botones de Mostrar
    ...
    def showblan(self):
        cv2.imshow('Final blancos', mascara_blancos)

    def showneg(self):
        cv2.imshow('Final negros', mascara_negro)
...
#Definir Funciones para botones de Guardar
    def saveroj(self):
        save, ok = QFileDialog.getSaveFileName(self, 'Guardar en...', 'C:\\Users', '(*.png)')
        if ok:
            cv2.imwrite(save,mask)
            QMessageBox.about(self,"Guardado Exitoso","Se ha guardado el análisis de color Rojo con éxito")
    
    def saveve(self):
        save, ok = QFileDialog.getSaveFileName(self, 'Guardar en...', 'C:\\Users', '(*.png)')
        if ok:
            cv2.imwrite(save,mascara_verde)
            QMessageBox.about(self, "Guardado Exitoso","Se ha guardado el análisis de color Verde con éxito")
        
    def saveaz(self):
        save, ok = QFileDialog.getSaveFileName(self, 'Guardar en...', 'C:\\Users', '(*.png)')
        if ok:
            cv2.imwrite(save,mascara_azul)
            QMessageBox.about(self, "Guardado Exitoso","Se ha guardado el análisis de color Azul con éxito")
            
    def saveci(self):
        save, ok = QFileDialog.getSaveFileName(self, 'Guardar en...', 'C:\\Users', '(*.png)')
        if ok:
            cv2.imwrite(save,mascara_cian)
            QMessageBox.about(self, "Guardado Exitoso","Se ha guardado el análisis de color Cian con éxito")
                
    def savean(self):
        save, ok = QFileDialog.getSaveFileName(self, 'Guardar en...', 'C:\\Users', '(*.png)')
        if ok:
            cv2.imwrite(save,mascara_anaranjado)
            QMessageBox.about(self, "Guardado Exitoso","Se ha guardado el análisis de color Anaranjado con éxito")
    
    def saveam(self):
        save, ok = QFileDialog.getSaveFileName(self, 'Guardar en...', 'C:\\Users', '(*.png)')
        if ok:
            cv2.imwrite(save,mascara_amarillo)
            QMessageBox.about(self,"Guardado Exitoso","Se ha guardado el análisis de color Amarillo con éxito")
    
    def savevi(self):
        save, ok = QFileDialog.getSaveFileName(self, 'Guardar en...', 'C:\\Users', '(*.png)')
        if ok:
            cv2.imwrite(save,mascara_violeta)
            QMessageBox.about(self, "Guardado Exitoso","Se ha guardado el análisis de color Violeta con éxito")
    
    def saveros(self):
        save, ok = QFileDialog.getSaveFileName(self, 'Guardar en...', 'C:\\Users', '(*.png)')
        if ok:
            cv2.imwrite(save,mascara_rosa)
            QMessageBox.about(self, "Guardado Exitoso","Se ha guardado el análisis de color Rosas con éxito")

    def savecaf(self):
        save, ok = QFileDialog.getSaveFileName(self, 'Guardar en...', 'C:\\Users', '(*.png)')
        if ok:
            cv2.imwrite(save,mascara_cafe)
            QMessageBox.about(self, "Guardado Exitoso","Se ha guardado el análisis de color Café con éxito")

    def saveblan(self):
        save, ok = QFileDialog.getSaveFileName(self, 'Guardar en...', 'C:\\Users', '(*.png)')
        if ok:
            cv2.imwrite(save,mascara_blancos)
            QMessageBox.about(self, "Guardado Exitoso","Se ha guardado el análisis de color Blanco con éxito")
        
    def saveneg(self):
        save, ok = QFileDialog.getSaveFileName(self, 'Guardar en...', 'C:\\Users', '(*.png)')
        if ok:
            cv2.imwrite(save,mascara_negro)
            QMessageBox.about(self, "Guardado Exitoso","Se ha guardado el análisis de color negro con éxito")

    def savegri(self):
        save, ok = QFileDialog.getSaveFileName(self, 'Guardar en...', 'C:\\Users', '(*.png)')
        if ok:
            cv2.imwrite(save,mascara_gris)
            QMessageBox.about(self, "Guardado Exitoso","Se ha guardado el análisis de colores Grises con éxito")
...
class Ventanacolor(QMainWindow):
    ...
    def mosroj(self):
        cv2.imshow('Espectro rojo detectado ', col3)

    def mosver(self):
        cv2.imshow('Espectro verde detectado ', col1)    

    def mosazu(self):
        cv2.imshow('Espectro azul detectado ', col4)

    def moscia(self):
        cv2.imshow('Espectro cian detectado ', col5)

    def mosana(self):
        cv2.imshow('Espectro anaranjado detectado ', col2)

    def mosama(self):
        cv2.imshow('Espectro amarillo detectado ', col6)

    def mosros(self):
        cv2.imshow('Espectro rosa detectado ', col7)
        
    def mosvio(self):
        cv2.imshow('Espectro violeta detectado ', col8)
    
    def mosblan(self):
        cv2.imshow('Espectro blanco detectado ', col11)
    
    def mosneg(self):
        cv2.imshow('Espectro negro detectado ', mascara_negro)
    
    def moscaf(self):
        cv2.imshow('Espectro café detectado ', col9)
    
    def mosgri(self):
        cv2.imshow('Espectro gris detectado ', col10)
#Definir Funciones para botones de Guardar
    def guarroj(self): 
        save, ok = QFileDialog.getSaveFileName(self, 'Guardar en...', 'C:\\Users', '(*.png)')
        if ok:
